...
def test_risk_result_exposes_execution_prices():
    result = evaluate_risk(equity=10000.0, entry=1.25, stop_loss=1.2485, take_profit=1.2545, atr=0.002, prior_loss_streak=0, peak_equity=10000.0)
...
def test_materially_below_3r_still_fails():
    result = evaluate_risk(equity=10000.0, entry=1.25, stop_loss=1.2485, take_profit=1.2544, atr=0.002, prior_loss_streak=0, peak_equity=10000.0)
