...
def wave2(
    wave1_high: Optional[float],
    wave1_low: Optional[float],
    wave2_extreme: Optional[float],
) -> Result:
...
def wave3(
    length1: Optional[float], length3: Optional[float], length5: Optional[float]
) -> Result:
...
def wave4(
    wave1_low: Optional[float], wave1_high: Optional[float], wave4_price: Optional[float]
) -> Result:
...
def system_discipline(
    system_defined: Optional[bool], regime_checked: Optional[bool]
) -> Result:
